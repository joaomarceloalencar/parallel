...
int main (int argc, char *argv[]) {
	...
	if (WINDOWS) fopen_s(&programHandle, "MatrixMultNaive.cl", "r");             // Alterei para fopen_s
	if (LINUX) programHandle = fopen("MatrixMultNaive.cl", "r");
	...
	ckKernel = clCreateKernel(cpProgram, "MatrixMultNaive", &status);
