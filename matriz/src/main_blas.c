...
int main(int argc, char *argv[]) {
   ...
   */
   ...
   cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, matrizA.n, matrizB.m, matrizA.m, 1.0, matrizA.data, matrizA.m, matrizB.data, matrizB.m, 0.0, resultado.data, matrizB.m);
