...
## Task 15
S = {-4, -2, 1, 2, 5, 0}
exclude_zero_list =  [ (x,y,z) for x in S for y in S for z in S if x+y+z == 0 if (x,y,z) != (0,0,0) ]

## Task 16
first_of_tuples_list = [ (x,y,z) for x in S for y in S for z in S if x + y + z == 0 if x != 0 if y != 0 if z != 0 ][0]
...
k = 'James'
value_list = [ name[k] for name in dlist ]
